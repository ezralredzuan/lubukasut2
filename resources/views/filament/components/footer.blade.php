...
.footer-39201 {
  ...
  <body>
    ...
    <footer class="footer-14398 py-4">
        <div class="container">
            <div class="container">
                <div class="row">
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                      <li><a href="#" style="color: grey; text-decoration: none;">Sell online</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Features</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Examples</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Website editors</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Online retail</a></li>
                    </ul>
                  </div>
                  <div class="col-md-3">
                    <h3>Press</h3>
                    <ul class="list-unstyled">
                      <li><a href="#" style="color: grey; text-decoration: none;">Events</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">News</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Awards</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Testimonials</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Online retail</a></li>
                    </ul>
                  </div>
                  <div class="col-md-3">
                    <h3>About</h3>
                    <ul class="list-unstyled">
                      <li><a href="#" style="color: grey; text-decoration: none;">Contact</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Services</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Team</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Career</a></li>
                      <li><a href="#" style="color: grey; text-decoration: none;">Contacts</a></li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <!-- Centered Privacy Policy, Terms, Code of Conduct -->
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
              <ul class="list-unstyled d-flex gap-3">
                <li><a href="#" style="color: grey; text-decoration: none;">Privacy Policy</a></li>
                <li><a href="#" style="color: grey; text-decoration: none;">Terms &amp; Conditions</a></li>
                <li><a href="#" style="color: grey; text-decoration: none;">Code of Conduct</a></li>
              </ul>
            </div>
          </div>
